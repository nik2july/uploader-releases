...
export const DEFAULT_ROLE_GROUPS: StudioRoleGroup[] = [
  ...
  { id: 'grp-social-media', name: 'Social Media & Reels', kind: 'deliverable', description: 'Instagram reels, teasers and viral social content.', isSystem: true },
...
export const DEFAULT_CREW_ROLES: CrewRoleConfig[] = [
  ...
  // Deliverables — services produced after the shoot.
  {
    ...
    name: 'Full Coverage Video',
    category: 'post-production',
    postProductionBasis: 'per_raw_hour',
    defaultRate: 1000,
    defaultCostRate: 1000,
    hourlyRawDataSellingRate: 2500,
    hourlyRawDataCostRate: 1000,
    clientBillingRate: 2500,
    unit: 'per_hour',
    isSystem: true,
    permanent: true,
    description: 'Full unedited raw footage ceremony and stage coverage. Calculated post-shoot per hour of raw camera footage.',
  },
  {
    id: 'role-trailer',
    groupId: 'grp-video-editor',
    ...
    category: 'post-production',
    postProductionBasis: 'per_output_minute',
    defaultQuantity: 5,
    defaultRate: 6000,
    defaultCostRate: 6000,
    clientBillingRate: 15000,
    estimatedEffortHours: 16,
    isSystem: true,
    description: '4K signature cinematic trailer. Standard 5-minute cut length with bespoke music scoring and color grading.',
  },
  {
    id: 'role-reels',
    groupId: 'grp-social-media',
    name: 'Instagram Reels',
    category: 'post-production',
    postProductionBasis: 'per_item',
    defaultQuantity: 3,
    defaultRate: 4500,
    defaultCostRate: 4500,
    clientBillingRate: 12000,
    fixedTurnaroundHours: 48,
    estimatedEffortHours: 6,
    isSystem: true,
    description: 'High-energy 9:16 vertical reels optimized for Instagram and social media sharing. Default 3 reels package.',
  },
  {
    id: 'role-instagram-post',
    groupId: 'grp-social-media',
    ...
    defaultQuantity: 5,
    defaultRate: 2000,
    defaultCostRate: 2000,
    clientBillingRate: 5000,
    fixedTurnaroundHours: 24,
    estimatedEffortHours: 4,
    isSystem: true,
    description: 'Curated social media image carousel posts, color-graded and formatted for Instagram feeds.',
  },
  {
    id: 'role-album',
    groupId: 'grp-album',
    name: 'Wedding Album',
    category: 'post-production',
    postProductionBasis: 'per_sheet',
    defaultQuantity: 40,
    defaultRate: 12000,
    defaultCostRate: 12000,
    clientBillingRate: 25000,
    unit: 'per_sheet',
    isSystem: true,
    permanent: true,
    description: 'Handcrafted luxury heirloom photo album. Standard 40 sheets (80 pages). Design, typography and printing included.',
  },
  {
    id: 'role-photo-editor',
    groupId: 'grp-photo-editor',
    name: 'Curated Edited Photos',
    category: 'post-production',
    postProductionBasis: 'per_photo',
    defaultQuantity: 300,
    defaultRate: 10000,
    defaultCostRate: 10000,
    perPhotoRate: 35,
    clientBillingRate: 25000,
    isSystem: true,
    permanent: true,
    description: 'Master color-graded, balanced, and retouched high-resolution digital photographs (300 photos standard).',
  },
  {
    id: 'role-photo-culling',
    groupId: 'grp-photo-editor',
    name: 'Photo Culling & Selection',
    category: 'post-production',
    postProductionBasis: 'per_raw_photo',
    defaultQuantity: 3000,
    defaultRate: 1500,
    defaultCostRate: 1500,
    clientBillingRate: 3000,
    isSystem: true,
    description: 'First-pass sorting, duplicate removal, blink filtering and curation from all raw camera card dumps.',
  },
  {
    ...
    defaultQuantity: 30,
    defaultRate: 15000,
    defaultCostRate: 15000,
    flatVideoRate: 15000,
    clientBillingRate: 35000,
    isSystem: true,
    permanent: true,
    description: 'Extended signature wedding film (30 minutes). Storyline montage, sound design, and master cinematic cut in DaVinci/Premiere.',
  },
  {
