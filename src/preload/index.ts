...
const api: DesktopAPI = {
  ...
  configureDrive: (id, secret) => ipcRenderer.invoke('drive:configure', id, secret),
  connectDrive: () => ipcRenderer.invoke('drive:connect'), driveStatus: () => ipcRenderer.invoke('drive:status'),
